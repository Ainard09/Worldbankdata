...
def cleandata(dataset, keepcolumns = ['Country Name', '1990', '2015'], value_variables = ['1990', '2015']):
    ...
    top10country = ['Nigeria','Egypt, Arab Rep.','South Africa','Algeria','Morocco', 'Angola','Kenya','Ethiopia','Tanzania','Ghana']
...
# second chart plots rural population for 2015 as a bar chart    
    graph_two= []
    df_two = cleandata('data/API_SP.RUR.TOTL_DS2_en_csv_v2_9914824.csv', ['Country Name', '2015'], ['2015'])
