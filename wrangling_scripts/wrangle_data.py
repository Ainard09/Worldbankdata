...
def cleandata(dataset, keepcolumns=['Country Name', '1990', '2015'], value_variables=['1990', '2015']):
    ...
    in Africa the columns into a year, country and value
    ...
    top10country = ['Nigeria', 'Egypt, Arab Rep.', 'South Africa', 'Algeria',
                    'Morocco', 'Angola', 'Kenya', 'Ethiopia', 'Tanzania', 'Ghana']
...
def return_figures():
  ...
  # first chart plots arable land from 1990 to 2015 in top 10 economies in Afirca
  # as a line chart

    graph_one = []
    df = cleandata(
        'home/azeez/webapp_worldbank/data/API_AG.LND.ARBL.HA.PC_DS2_en_csv_v2.csv')
...
# second chart plots rural population for 2015 as a bar chart
    graph_two = []
    df_two = cleandata('home/azeez/webapp_worldbank/data/API_SP.RUR.TOTL_DS2_en_csv_v2_9914824.csv',
                       ['Country Name', '2015'], ['2015'])

    df_two.columns = ['country', 'year', 'ruralpopulation']
    df_two.sort_values('ruralpopulation', ascending=False, inplace=True)

    graph_two.append(
        go.Bar(
            x=df_two.country.tolist(),
            y=df_two.ruralpopulation.tolist(),
        )
    )

    layout_two = dict(title='Rural Population in 2015',
...
# third chart plots percent of population that is rural from 1990 to 2015
    graph_three = []
    df = cleandata(
        'home/azeez/webapp_worldbank/data/API_SP.RUR.TOTL.ZS_DS2_en_csv_v2_9948275.csv')
...
# fourth chart shows rural population vs arable land
    ...
    df_one = cleandata(
        'home/azeez/webapp_worldbank/data/API_SP.RUR.TOTL_DS2_en_csv_v2_9914824.csv', keepcolumns, valuevariables)
    df_two = cleandata(
        'home/azeez/webapp_worldbank/data/API_AG.LND.FRST.K2_DS2_en_csv_v2_9910393.csv', keepcolumns, valuevariables)
